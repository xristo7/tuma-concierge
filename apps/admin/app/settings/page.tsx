        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <section className="home-card space-y-3">
            ...
            <div className="space-y-1">
              ...
              />
              <p className="text-xs text-ink-500">
                A floor on the distance-priced fee above — a rider still has to go collect and deliver the item
                even on a very short ride, so this is never allowed to round down toward free.
              </p>
            </div>
            <div className="space-y-1">
 ...
 * outside the big settings form, with its own immediate save and an
 * explicit confirmation step, since this is the single most consequential
 * toggle in the app: every customer and rider sees a different dataset the
 * instant it flips. See api.adminSetPlatformEnvironment.
 */
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="min-w-0 flex-1">
          <span className="flex flex-wrap items-center gap-1.5">
            <h2 className="text-sm font-semibold text-ink">Platform state</h2>
            <span
