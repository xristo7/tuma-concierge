...
/** The default map picker — OpenStreetMap tiles via Leaflet, Nominatim for
 * search/reverse-geocoding. Free, no API key, never disabled by admin —
 * see ../LocationMapPicker.tsx for when Google/Mapbox is used instead. */
export function StreetMapsPicker({ initial, onConfirm, onCancel }: MapPickerProps) {
